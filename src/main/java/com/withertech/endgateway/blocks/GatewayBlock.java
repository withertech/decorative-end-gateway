...
public class GatewayBlock extends BaseTileBlock<GatewayTile>
{
    ...
    @Override
    protected ITextComponent getDisplayName(GatewayTile tile)
    {
    ...
    {
        return EndGateway.INSTANCE.REGISTRY.getTile(TypedRegKey.tile("gateway_tile", GatewayTile.class)).get().create();
    }
}
