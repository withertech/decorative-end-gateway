...
public class GatewayTile extends BaseTileEntity<GatewayTile>
{
    public GatewayTile()
    {
        super(EndGateway.INSTANCE.REGISTRY.getTile((TypedRegKey.tile("gateway_tile", GatewayTile.class))).get());
    }
