...
public class GatewayTileRenderer extends TileEntityRenderer<GatewayTile>
{
    public static final Random RANDOM = new Random(31100L);
    public static final List<RenderType> RENDER_TYPES = IntStream.range(0, 16).mapToObj((p_228882_0_) -> RenderType.endPortal(p_228882_0_ + 1)).collect(ImmutableList.toImmutableList());

    public GatewayTileRenderer(TileEntityRendererDispatcher p_i226019_1_)
    {
        super(p_i226019_1_);
    }

    public void render(GatewayTile p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_)
    {
    ...
    private void renderCube(GatewayTile p_228883_1_, float p_228883_2_, float p_228883_3_, Matrix4f p_228883_4_, IVertexBuilder p_228883_5_)
    {
